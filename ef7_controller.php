...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $Respuesta = [];
//Ejecutar Query
    $query = "SELECT * FROM Dim_EF7 Order By EF7";
...
//Imprimir json:
    ...
    $query4="Insert into Dim_EF7 (EF7,EF7_Desc) values ('{$_POST['ef1_orden']}','{$_POST['ef1_desc']}')";
    ...
    $tsql = "UPDATE Dim_RangoCuentas SET EF7 = (?), EF7Desc = (?) WHERE EF7 = (?) AND EF7Desc = (?)";
    ...
    $tsqli = "UPDATE Dim_EF7 SET EF7 = '{$EF1_Orden}', EF7_Desc = '{$ef1Desc}' WHERE id_ef7 = (?)";
    ...
    $query4="Delete From Dim_EF7 where id_ef7 = (?)";
