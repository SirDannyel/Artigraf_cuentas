...
<script>
    ...
    const EF1_service = () => {
        return new Promise(function (resolve, reject) {
            ...
            objXMLHttpRequest.open('get', 'getEF2.php');
    ...
    const EF1Insert_service = (ef1_orden_nvo,ef1_desc_nvo) => {
        ...
        return new Promise(function (resolve, reject) {
            ...
            objXMLHttpRequest.open('POST', 'ef2_controller.php');
    ...
    const EF1Delete_service = (ID) => {
        ...
        const data = JSON.stringify({ tipo: "delete",id : ID});
        return new Promise(function (resolve, reject) {
            const objXMLHttpRequest = new XMLHttpRequest();
    ...
    const getEF1_table = async () => {
        try{
            ...
            for(var i = 0; i < EF1_Catalogo.length; i++) {
                ...
                var opt = EF1_Catalogo[i].EF2_Desc;
                ...
                editar.setAttribute("name", EF1_Catalogo[i].EF2_Desc);
                editar.setAttribute("id", EF1_Catalogo[i].EF2);
                editar.setAttribute("class", "btn btn-outline-warning px-3");
                editar.setAttribute("type", "button");
                editar.textContent = "Editar";
                editar.value = EF1_Catalogo[i].id_ef2;
                ...
                boton.setAttribute("name", EF1_Catalogo[i].id_ef2);
                boton.setAttribute("id", EF1_Catalogo[i].id_ef2);
    ...
    const update_ef1 = (id,ef1_orden_ant, ef1_desc_ant,ID_EF_NVO,ef1_desc_nvo) => {
        ...
        try {
            ...
            EF1_Catalogo.map(function (dato) {
                if (dato.id_ef2 == Rango) {
                    if (ID_EF_NVO) {
                        dato.EF2 = ID_EF_NVO;

                    }
                    if(ef1_desc_nvo) {
                        dato.EF2_Desc = ef1_desc_nvo;
                    }
