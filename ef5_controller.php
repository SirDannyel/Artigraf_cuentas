...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $Respuesta = [];
//Ejecutar Query
    $query = "SELECT * FROM Dim_EF5 Order By EF5";
...
//Imprimir json:
    ...
    $query4="Insert into Dim_EF5 (EF5,EF5_Desc) values ('{$_POST['ef1_orden']}','{$_POST['ef1_desc']}')";
    ...
    $query4="Delete From Dim_EF5 where id_ef5 = (?)";
