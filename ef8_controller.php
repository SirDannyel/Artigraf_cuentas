...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $Respuesta = [];
//Ejecutar Query
    $query = "SELECT * FROM EF8_Select Order By EF8";
...
//Imprimir json:
    ...
    $query4="Insert into EF8_Select (EF8,EF8_Desc) values ('{$_POST['ef8_orden']}','{$_POST['ef8_desc']}')";
    ...
    $EF8_Orden = intval($data->ef8_orden_nvo);
    $ef8Desc = $data->ef8_desc_nvo;
    $Params = array($id_number);
    $Params2 = array($data->ef8_orden_nvo,$data->ef8_desc_nvo,$data->ef8_orden_ant,$data->ef8_desc_ant);
    ...
    $tsqli = "UPDATE EF8_Select SET EF8 = '{$EF8_Orden}', EF8_Desc = '{$ef8Desc}' WHERE id_ef8 = (?)";
    ...
    $query4="Delete From EF8_Select where id_ef8 = (?)";
