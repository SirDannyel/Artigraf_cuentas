    ...
    const getEF1_table = async () => {
        try{
            ...
            for(var i = 0; i < EF1_Catalogo.length; i++) {
                ...
                var opt = EF1_Catalogo[i].EF6_Desc;
                ...
                editar.setAttribute("name", EF1_Catalogo[i].EF6_Desc);
                editar.setAttribute("id", EF1_Catalogo[i].EF6);
                editar.setAttribute("class", "btn btn-outline-warning px-3");
                editar.setAttribute("type", "button");
                editar.textContent = "Editar";
                editar.value = EF1_Catalogo[i].id_ef6;
                ...
                boton.setAttribute("name", EF1_Catalogo[i].id_ef6);
                boton.setAttribute("id", EF1_Catalogo[i].id_ef6);
