...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $Respuesta = [];
//Ejecutar Query
    $query = "SELECT * FROM Dim_EF3 Order By EF3";
...
//Imprimir json:
    ...
    $query4="Insert into Dim_EF3 (EF3,EF3_Desc) values ('{$_POST['ef1_orden']}','{$_POST['ef1_desc']}')";
    ...
    $query4="Delete From Dim_EF3 where id_ef3 = (?)";
