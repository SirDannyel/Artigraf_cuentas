...
<script>
    ...
    const EF1_service = () => {
        return new Promise(function (resolve, reject) {
            ...
            objXMLHttpRequest.open('GET', 'getEF8.php');
    ...
    const EF1Insert_service = (ef1_orden_nvo,ef1_desc_nvo) => {
        return new Promise(function (resolve, reject) {
            ...
            objXMLHttpRequest.open('POST', 'ef8_controller.php');
    ...
    const EF1Update_service = (ID,Ef1_orden_ant,Ef1_desc_ant,ID_EF_NVO,Ef1_desc_nvo) => {
        ...
        let data =
            JSON.stringify({
                ...
                ef1_desc_nvo : Ef1_desc_nvo, tipo : "update"});
    ...
    const update_ef1 = (id,ef1_orden_ant, ef1_desc_ant,ID_EF_NVO,ef1_desc_nvo) => {
        ...
        try {
            ...
            EF1_Catalogo.map(function (dato) {
                if (dato.id_ef8 == Rango) {
                    if (ID_EF_NVO) {
                        dato.EF8 = ID_EF_NVO;

                    }
                    if(ef1_desc_nvo) {
                        dato.EF8_Desc = ef1_desc_nvo;
                    }
